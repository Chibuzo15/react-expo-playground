...
class Login extends Component {
    ...
    render() {
        ...
        const message = <View className={classes.Message}>
            {this.props.location.state ? this.props.location.state.message : null}
        </View>

        let pageContent = <View className={classes.PageWrapper}>
            {message}
            {form}
            <View className={classes.Forgot}>
        ...
        if (this.props.loggedIn) {
            pageContent = <View className={classes.Success}>You are successfully logged In</View>
